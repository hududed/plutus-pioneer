...
-- mkValidator :: VestingDatum -> () -> ScriptContext -> Bool
-- mkValidator dat () ctx =
--     ( traceIfFalse "beneficiary1 sig missing" checkSig1        &&
--       traceIfFalse "deadline1 has passed"      checkDeadline1
--     ) ||
--     ( traceIfFalse "beneficiary2 sig missing" checkSig2        &&
--       traceIfFalse "deadline2 not reached"     checkDeadline2
--     )
--   where
--     info :: TxInfo
--     info = scriptContextTxInfo ctx
