...
-- {-# INLINABLE check #-}
-- check :: ByteString -> ByteString -> ByteString -> GameDatum -> GameRedeemer -> ScriptContext -> Bool
-- check bsRock' bsScissors' bsPaper' (GameDatum bs (Just _)) (Reveal nonce c) _ =
--        sha2_256 (nonce `concatenate` case c of {Rock->bsRock';Scissors->bsScissors';Paper->bsPaper'}) == bs
-- check _       _        _           _                        _               _ = True
...
firstGame fp = do
    ...
    let game   = Game
        ...
        -- bs     = sha2_256 $ fpNonce fp `concatenate` case c of {Rock->bsRock;Scissors->bsScissors;Paper->bsPaper}
    ...
    case m of
        ...
        Just ((o, _), _) -> case tyTxOutData o of
            ...
            --     logInfo @String "second player played and draws"
            --     void $ mapError' $ runStep client $ Reveal $ fpNonce fp
            --     logInfo @String "first player revealed, draws, stakes returned"

            -- GameDatum _ (Just c') | beats c' c -> do
            --     logInfo @String "second player played and won"
            --     void $ mapError' $ runStep client $ Reveal c $ fpNonce fp
            --     logInfo @String "first player revealed, lost, second player claims 2X stake"
